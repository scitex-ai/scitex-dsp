...
# (project=scitex-dsp, owner=ywatanabe1989, repo=scitex-dsp,
...
TMPDIR="/tmp/publish-scitex_dsp-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-dsp dist/* uploaded to PyPI via manual OIDC trusted publishing"
