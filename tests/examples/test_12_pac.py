"""Smoke test for examples/12_pac.ipynb — runs jupyter nbconvert --execute."""
...
def test_12_pac_notebook_exists(tmp_path: Path) -> None:
    # Arrange
    # Act
    # Assert
    # Arrange
...
def test_12_pac_r_returncode_equals_n_0(tmp_path: Path) -> None:
    # Arrange
